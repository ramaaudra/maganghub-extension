...
Refreshing a Favorite's Status Kuota fetches the Lowongan's public detail-page URL and parses the HTML. These fetches are done from an **MV3 offscreen document**, not the background service worker.
